...
class Enemy:
    """Represent a concrete enemy with spatial state and health.

    Attributes:
        entity: Spatial entity used for identity, geometry, and active state.
        health: Current health remaining before defeat.
    """
    ...
    def take_damage(self, damage: int) -> bool:
        """Apply damage and report whether this hit defeated the enemy."""
        if damage <= 0:
